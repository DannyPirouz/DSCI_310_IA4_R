...
We present the standard deviations in Table @tbl-results .
...
Table: Standard deviation of historical (1906-1972) horse populations for each Canadian province {#tbl-results}
Note that we define standard deviation (of a sample) as

$$s = \sqrt{\frac{\sum_{i=1}^N (x_i - \overline{x})^2}{N-1} }$$

Additionally, note that in Table @tbl-results we consider the sample standard deviation of the number of horses during the same time span as Figure 1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horsedeviation width=65%}
