...
![Horse Population for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-horse width=65%}
...
We present the standard deviations in @tbl-results .
...
Additionally, note that in @tbl-results we consider the sample standard deviation of the number of horses during the same time span as @fig-horse.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horsedeviation width=65%}

<!-- Figure 2: Horse populations for the province with the largest standard deviation -->

In @fig-horsedeviation we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
